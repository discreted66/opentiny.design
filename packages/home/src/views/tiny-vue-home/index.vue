    ...
    <section class="feature-section section bg-tech-1 pad-t40 content-around">
      ...
      <div class="feature-visual pad-t40 fade-in-up">
        <img
          ...
          alt="跨端跨框架"
          class="floating-img shuttle-x-reverse"
        />
      </div>
    </section>
      ...
      <div class="feature-content pad-t40 content-center fade-in-up">
        <div class="feature-visual">
          <img
            ...
            alt="主题定制"
            class="theme-item-img theme-left shuttle-x"
          />
        </div>
        <div class="feature-visual">
          <img
            ...
            alt="主题定制"
            class="theme-item-img shuttle-x-reverse"
          />
        </div>
      </div>
    </section>
...
.shuttle-x {
  animation: shuttleX 6s ease-in-out infinite;
  will-change: transform;
}

.shuttle-x-reverse {
  animation: shuttleXReverse 6.5s ease-in-out infinite;
  will-change: transform;
}
